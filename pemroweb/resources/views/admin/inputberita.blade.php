...
error('title') dapat digunakan untuk menampilkan pesan ketika terjadi error saat validasi-->
            <input type="text" name="title" value="{{ old('title') }}" class="@error( 'title') border-red-500 
            @enderror focus:ring-indigo-500 focus:border-indigo-500 flex-
            1 block w-full rounded-none rounded-r-md sm:text-sm border - gray - 300 border-gray-300 text-black" >   
                                </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea name="description" rows="2" class="@error('description') border- red-500 @enderror shadow-sm 
                                focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border - gray - 300 border-gray-300 text-black rounded- md" placeholder="Text isian berita ">
